...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DeviceManufacturer", {PERSISTENT, STRING}},
    {"DeviceModel", {PERSISTENT, STRING}},
    ...
    {"FlowpilotPID", {CLEAR_ON_MANAGER_START, INT}},
    ...
    {"ResetExtrinsicCalibration", {CLEAR_ON_MANAGER_START, BOOL}},
    ...
    {"UserEmail", {PERSISTENT, STRING}},
    {"UserID", {PERSISTENT, STRING}},
    {"UserToken", {PERSISTENT, STRING}},
    {"Mycar", {PERSISTENT, STRING}},
    {"UseAccel", {PERSISTENT, BOOL}},
    {"UseDistSpeed", {PERSISTENT, BOOL}},
    {"SensitiveSlow", {PERSISTENT, BOOL}},
    {"UseModelPath", {PERSISTENT, BOOL}},
    {"CameraMatrix", {PERSISTENT, BYTES}},
    {"DistortionCoefficients", {PERSISTENT, BYTES}},
    {"WideCameraMatrix", {PERSISTENT, BYTES}},
    {"WideDistortionCoefficients", {PERSISTENT, BYTES}},
    {"WideCameraOnly", {PERSISTENT, BOOL}},
